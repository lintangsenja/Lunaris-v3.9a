    ...
    companion object {
        ...
        private fun migrateDatabaseToLatest(database: SupportSQLiteDatabase) {
            val tableCreateQueries = mapOf(
                ...
                "items" to "CREATE TABLE IF NOT EXISTS `items` (`idBarang` TEXT NOT NULL, `namaBarang` TEXT NOT NULL, `stokAwal` INTEGER NOT NULL, `kategori` TEXT NOT NULL, `satuan` TEXT NOT NULL, `stokRusak` INTEGER NOT NULL, `merekAlat` TEXT NOT NULL, `ruang` TEXT NOT NULL, `sumberDana` TEXT, `kondisi` TEXT NOT NULL, `keterangan` TEXT NOT NULL, `isDemo` INTEGER NOT NULL DEFAULT 0, `type` TEXT NOT NULL DEFAULT 'ALAT', PRIMARY KEY(`idBarang`))",
        ...
        fun getDatabase(context: Context): AppDatabase {
            return INSTANCE ?: synchronized(this) {
                val migrations = (1..15).map { start ->
                    object : Migration(start, 16) {
